...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Text = L"Incoming DownlinkTransfer";
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &DownlinkTransfer::IncomingTransfer_FormClosing);
