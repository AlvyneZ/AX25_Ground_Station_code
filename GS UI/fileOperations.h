...
bool GSUI::MyForm::checkIfFileExists(std::string file_path) {
...
uint32_t GSUI::MyForm::getFileSize(std::string file_path) {
...
std::vector<uint8_t> GSUI::MyForm::retrieveFileToTransfer(std::string input_path) {
...
std::vector< std::vector<uint8_t> > GSUI::MyForm::splitFileIntoPackets(std::vector<uint8_t> file) {
...
void GSUI::MyForm::compilePackets(std::string output_path, std::vector< std::vector<uint8_t> > packets) {
